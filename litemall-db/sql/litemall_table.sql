...
CREATE TABLE `litemall_user` (
  ...
  `credit` int(11) NOT NULL DEFAULT '0' COMMENT '目前积分',
...
DROP TABLE IF EXISTS `litemall_user_credit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litemall_user_credit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(63) NOT NULL COMMENT '用户名称',
  `credit` int(11) NOT NULL DEFAULT 0 COMMENT '积分',
  `modify_by` varchar(250) DEFAULT NULL COMMENT '变化原因',
